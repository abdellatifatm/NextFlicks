...
export function Footer() {
  return (
    <ScrollReveal>
      <footer className="relative text-blue-gray-900 dark:text-gray-200 dark:bg-gray-900/30 bg-white/40 backdrop-blur-xl border-none rounded-lg shadow-lg  m-10 py-2">
          ...
          <div className=" flex w-full flex-col items-center justify-center py-4 md:flex-row md:justify-between">
            ...
            >
              ...
              <span className=" underline">
                <a
                  target="_blank"
                  href="https://www.linkedin.com/in/abdellatif-ait-mahda"
                >
            ...
            <div className="flex gap-4 text-blue-gray-900  dark:text-gray-200  sm:justify-center">
              ...
              <Typography
                as="a"
                target="_blank"
                href="https://www.facebook.com/abdellatif.aitmahda.1"
              ...
              <Typography
                as="a"
                target="_blank"
                href="https://www.instagram.com/abdellatif.atm"
                className="opacity-80 transition-opacity hover:opacity-100"
              >
                <svg
                  className="h-5 w-5"
              ...
              <Typography
                as="a"
                target="_blank"
                href="https://github.com/abdellatifatm"
                className="opacity-80 transition-opacity hover:opacity-100"
              >
                <svg
                  className="h-5 w-5"
